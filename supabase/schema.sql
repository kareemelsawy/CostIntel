...
CREATE POLICY "auth_w_mat" ON materials FOR ALL USING (auth.role()='authenticated');
CREATE POLICY "pub_r_acc" ON accessories FOR SELECT USING (true);
CREATE POLICY "auth_w_acc" ON accessories FOR ALL USING (auth.role()='authenticated');
CREATE POLICY "pub_r_com" ON commercial_settings FOR SELECT USING (true);
CREATE POLICY "auth_w_com" ON commercial_settings FOR ALL USING (auth.role()='authenticated');
CREATE POLICY "pub_r_skus" ON skus FOR SELECT USING (true);
CREATE POLICY "auth_w_skus" ON skus FOR ALL USING (auth.role()='authenticated');
