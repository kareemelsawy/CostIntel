...
import { COLORS, CATEGORIES, CSV_COLUMNS } from '../lib/constants'
...
export default function CatalogPage({ skus, setSkus, skuCosts, setSelectedSku, setEditingSku, toast, catDefaults }) {
  ...
  const filtered = useMemo(() => {
    ...
    return [...list].sort((a,b)=>{
      ...
      switch(sortBy){case 'cost':va=ca?.production_cost||0;vb=cb?.production_cost||0;break;case 'margin':va=ca?.commercial?.net_margin_percent||0;vb=cb?.commercial?.net_margin_percent||0;break;case 'name':va=a.name||'';vb=b.name||'';break;default:va=a.sku_code;vb=b.sku_code}
