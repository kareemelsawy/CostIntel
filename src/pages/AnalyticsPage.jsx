  ...
  return (
    <div style={{padding:'24px 28px',overflowY:'auto',flex:1}}>
      ...
      <div style={{display:'flex',gap:12,marginBottom:20,flexWrap:'wrap'}}>
        <StatCard label="Avg. Cost (EGP)" value={fmt(stats.avgCost)} icon="box" color={COLORS.amber}/>
      ...
      <Card style={{marginBottom:20}}>
        ...
        <table style={{width:'100%',borderCollapse:'collapse',fontSize:13}}>
          <thead><tr style={{borderBottom:`1px solid ${COLORS.border}`}}>
            {['Category','Count','Avg. Cost (EGP)','Avg. Margin %'].map(h=>(
      ...
      <Card>
        <div style={{fontSize:14,fontWeight:700,color:COLORS.text,marginBottom:16}}>Top 15 by Production Cost (EGP)</div>
